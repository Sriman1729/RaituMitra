...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <header className="sticky top-0 z-50 backdrop-blur-sm bg-white/90 dark:bg-gray-900/90 text-gray-800 dark:text-gray-100 shadow-sm border-b border-gray-200/50 dark:border-gray-700/50 transition-all duration-500">
