...
export default function FertilizerCalculator() {
  ...
  if (loading)
    return (
      <div className="flex justify-center items-center h-96 text-violet-500">
  ...
  return (
    <div className="px-4 py-6 max-w-5xl mx-auto">
      <div className="p-6 rounded-2xl shadow-xl border border-violet-200 dark:border-violet-700 bg-gradient-to-br from-white via-violet-50 to-fuchsia-50 dark:from-neutral-900 dark:to-violet-950 transition-colors">
        <div className="flex items-center gap-3 mb-6">
          <Calculator className="w-8 h-8 text-violet-600 dark:text-violet-400" />
          <h2 className="text-2xl font-bold bg-gradient-to-r from-fuchsia-500 via-violet-500 to-indigo-500 text-transparent bg-clip-text">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full p-3 rounded-lg border border-violet-400 dark:border-violet-700 bg-white dark:bg-neutral-900"
            >
        ...
        <div className="mt-6 flex gap-3">
          <input
            ...
            className="flex-1 p-3 rounded-lg border border-violet-400 dark:border-violet-700 bg-white dark:bg-neutral-900"
          />
          <select
            value={unit}
            onChange={(e) => setUnit(e.target.value)}
            className="p-3 rounded-lg border border-violet-400 dark:border-violet-700 bg-white dark:bg-neutral-900"
          >
        ...
        <div className="mt-5">
          ...
          {useCustom && (
            <div className="mt-3 grid md:grid-cols-3 gap-3">
              {["Urea", "DAP", "MOP"].map((f) => (
                <div key={f} className="p-3 rounded-lg border border-violet-300 dark:border-violet-700 bg-violet-50/30 dark:bg-neutral-900">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {["N", "P", "K"].map((n) => (
                      <input
                        ...
                        placeholder={n}
                        className="p-2 rounded-md border border-violet-300 dark:border-violet-700 bg-white dark:bg-neutral-900"
                      />
                    ))}
                  </div>
                </div>
        ...
        <div className="mt-6 grid gap-3">
          <button
            ...
            className="w-full py-3 rounded-lg bg-gradient-to-r from-fuchsia-500 via-violet-500 to-indigo-500 text-white font-semibold shadow-md hover:shadow-violet-500/30 transition-all"
          >
            ➕ Add Crop to Farm
          </button>

          {farmCrops.length > 0 && (
            <div className="mt-3 p-4 rounded-lg border border-violet-200 dark:border-violet-700 bg-white dark:bg-violet-900 shadow">
              <h3 className="font-semibold text-violet-900 dark:text-violet-100 mb-3">Crops in Farm</h3>
              <ul className="space-y-3">
                {farmCrops.map((c, i) => (
                  <li key={i} className="p-3 rounded-md border border-violet-100 dark:border-violet-800 bg-violet-50 dark:bg-violet-800">
              ...
              <button
                ...
                className="mt-4 w-full py-2 rounded-lg bg-violet-600 hover:bg-violet-700 text-white font-semibold"
              >
        ...
        {/* Results */}
        {result && (
          <div className="mt-6 p-5 rounded-xl border border-violet-400 dark:border-violet-700 bg-gradient-to-br from-violet-50 to-indigo-50 dark:from-neutral-900 dark:to-violet-950">
            <h3 className="text-lg font-semibold mb-3 flex items-center gap-2">
              <Leaf className="w-5 h-5 text-violet-600" /> Farm Totals
            </h3>
            <div className="grid md:grid-cols-2 gap-3">
              <div className="p-3 rounded-lg border border-violet-200 dark:border-violet-700 bg-white dark:bg-neutral-900">
              ...
              <div className="p-3 rounded-lg border border-violet-200 dark:border-violet-700 bg-white dark:bg-neutral-900">
                ...
                <p className="mt-2 font-bold text-violet-700 dark:text-violet-400">
                  💰 Grand Total: ₹
